 ...
 */
package it.cnr.istc.stlab.ontonethub.solr;
...
/**
 * 
 * Interface that mirrors the SiteManager interface of the EntityHub.
 * OntoNetHub does not directly reuse the EntityHub's SiteManager as it extends its functionalities.
 * 
 * @author Andrea Nuzzolese (https://github.com/anuzzolese)
 *
 */

public interface OntoNetHubSiteManager {
