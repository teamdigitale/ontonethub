 ...
 */
package it.cnr.istc.stlab.ontonethub.solr.impl;
...
/**
 * Default implementation of the interface {@link OntoNetHubSiteManager}. <br/>
 * This class provides an OSGi component that extends the facilities of the EntityHub's SiteManager. 
 * 
...
@Service
@Properties(value={
	@Property(name = "ontonethub-sitemanager")
})
public class OntoNetHubSiteManagerImpl implements OntoNetHubSiteManager {

    private final Logger log;

//    private ComponentContext context;
    public OntoNetHubSiteManagerImpl(){
        super();
        log = LoggerFactory.getLogger(OntoNetHubSiteManagerImpl.class);
        log.info(" create instance of "+OntoNetHubSiteManagerImpl.class);
    }
    @Reference(
